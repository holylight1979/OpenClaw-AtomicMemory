...
| Extension | 說明 | 行數 |
|-----------|------|------|
| **atomic-memory** | 結構化知識記憶（信心分層 [固]/[觀]/[臨]、Ollama 萃取、向量搜尋、ACT-R scoring、token budget、cross-session consolidation）+ 四級權限（owner/admin/user/guest）+ Guest 存取管理 + 自我迭代工具 | ~2300 |
